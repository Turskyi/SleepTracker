package ua.turskyi.sleeptracker
...
private val ONE_MINUTE_MILLIS = TimeUnit.MILLISECONDS.convert(
    1,
    TimeUnit.MINUTES
)
...
fun convertDurationToFormatted(startTimeMilli: Long, endTimeMilli: Long, res: Resources): String {
    ...
    val weekdayString = SimpleDateFormat("EEEE", Locale.getDefault())
        .format(startTimeMilli)
    return when {
